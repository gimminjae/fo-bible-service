<template>
    <div>
        ...
        <div class="flex justify-center">
            <div v-if="bibleDetail.bookName" class="fixed modal-box z-10">
                <div method="dialog">
                    <div class="flex justify-between">
                        <h3 class="font-bold text-lg">{{ bibleDetail.bookName }}</h3>
                    ...
                    <div class="py-4">
                        <div class="grid grid-cols-5 gap-3">
                            <div class="indicator" v-for="(verse, index) in bibleDetail.verseStatus">
                    ...
                    <div class="flex justify-center gap-3">
                        <button class="btn btn-primary btn-wide">저장</button>
